<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Cadastro_Empresa.aspx.cs" Inherits="Cadastro_Empresa" %>
                    ...
                    <div class="col-md-12">
                        <div class="_lk_de">
                            <form runat="server">
                                ...
                                <div class="form-03-main" style="    width: 750px;">
                                    <div class="logo">
                                        <a href="Index.aspx">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <asp:TextBox ID="txtNome" runat="server" CssClass="form-control" placeholder="Nome do Responsável"></asp:TextBox>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <asp:TextBox ID="txtFantasia" runat="server" CssClass="form-control" placeholder="Nome Fantasia"></asp:TextBox>
                                            </div>
                                            <div class="form-group">
                                                <asp:TextBox ID="txtRazao" runat="server" CssClass="form-control" placeholder="Razão Social"></asp:TextBox>
                                            </div>
